...
export const sendMessage = async (req, res) => {
  try {
    ...
    // Store image as base64 directly (frontend already compresses to JPEG 85%, max 1200px)
    // Cloudinary upload is used only for profile pictures via the profile update route
